        ...
        <div class="uk-grid-divider" uk-grid>
            ...
            <div class="uk-width-1-1@s uk-width-1-1@m">
                ...
                <nav class="uk-navbar-container uk-margin" uk-navbar>
                    ...
                    <div class="nav-overlay uk-navbar-left">
                        ...
                        <a class="uk-navbar-item uk-logo" uk-toggle="target: .nav-overlay; animation: uk-animation-fade"
                            href="#">Clique para uma nova pesquisa</a>
                        ...
                        <div class="uk-navbar-item uk-width-expand">
                            <form class="uk-search uk-search-navbar uk-width-1-1">
                                ...
                                <input class="uk-search-input" type="search" name="search[]"
                                    placeholder="Nova pesquisa..." autofocus>
                            </form>
                        </div>
            ...
            <div class="uk-width-1-1@s uk-width-1-1@m">
                ...
                <p class="uk-margin-top" uk-margin>
                    <a class="uk-button uk-button-default uk-button-small"
                        href="index.php"><?php echo $t->gettext('Começar novamente'); ?></a>
                    <?php 
            if (!empty($_GET["search"])) {
                foreach ($_GET["search"] as $querySearch) {
                    ...
                    echo '<a class="uk-button uk-button-default uk-button-small" href="https://'.$url_push.'">'.$querySearch.' <span uk-icon="icon: close; ratio: 1"></span></a>';
            ...
            if (!empty($_GET["filter"])) {
                foreach ($_GET["filter"] as $filters) {
                    ...
                    $url_push = $_SERVER['SERVER_NAME'].$_SERVER["SCRIPT_NAME"].'?'.http_build_query($diff);
                    echo '<a class="uk-button uk-button-primary uk-button-small" href="https://'.$url_push.'">Filtrado por: '.$filters.' <span uk-icon="icon: close; ratio: 1"></span></a>';
                    unset($filters_array);
                }
            }
            ...
            if (!empty($_GET["notFilter"])) {
                foreach ($_GET["notFilter"] as $notFilters) {
                    ...
                    $url_push = $_SERVER['SERVER_NAME'].$_SERVER["SCRIPT_NAME"].'?'.http_build_query($diff);
                    echo '<a class="uk-button uk-button-danger uk-button-small" href="https://'.$url_push.'">Ocultando: '.$notFilters.' <span uk-icon="icon: close; ratio: 1"></span></a>';
            ...
            <div class="uk-width-1-4@s uk-width-2-6@m">
                <div class="uk-panel">
                    ...
                    <form class="uk-form">
                        <fieldset>
                            ...
                            $(function() {
                                $("#limitar-data").slider({
                                    ...
                                    slide: function(event, ui) {
                                        $("#date").val("datePublished:[" + ui.values[0] + " TO " +
                                            ui.values[1] + "]");
                                    }
                                });
                            ...
                            <input type="hidden" name="search[]"
                                value="<?php echo str_replace('"','&quot;',$search_expression); ?>">
                            <?php endforeach; ?>
                            <?php endif; ?>
                    ...
                    <fieldset>
                        ...
                        <div class="uk-form-row"><a
                                href="<?php echo 'https://'.$_SERVER["SERVER_NAME"].'/~bdpi/report.php?'.$_SERVER["QUERY_STRING"].''; ?>"
                                class="uk-button-primary">Gerar relatório</a>
                        </div>
                    </fieldset>
                    <?php endif; ?>
                </div>
                ...
                <div class="uk-child-width-expand@s uk-grid-divider" uk-grid>
                    <div>
                        <ul class="uk-pagination">
                            ...
                            <li><a href="result.php?<?php echo http_build_query($get_data); ?>"><span
                                        class="uk-margin-small-right" uk-pagination-previous></span> Anterior</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        <ul class="uk-pagination">
                            ...
                            <li class="uk-margin-auto-left"><a
                                    href="result.php?<?php echo http_build_query($get_data); ?>">Próxima <span
                                        class="uk-margin-small-left" uk-pagination-next></span></a></li>
                            <?php else :?>
                            <li class="uk-margin-auto-left"><a href="#">Próxima <span class="uk-margin-small-left"
                        ...
                        <li>
                            <div class="uk-grid-divider uk-padding-small" uk-grid>
                                <div class="uk-width-1-5@m">
                                    <p>
                                        <a
                                            href="result.php?type[]=<?php echo $r["_source"]['type'];?>"><?php echo ucfirst(strtolower($r["_source"]['type']));?></a>
                                    </p>
                                </div>
                                <div class="uk-width-4-5@m">
                                    <article class="uk-article">
                                        <p class="uk-text-lead uk-margin-remove"><a class="uk-link-reset"
                                                href="http://dedalus.usp.br/F/?func=direct&doc_number=<?php echo  $r['_id'];?>"
                                                target="_blank"><?php echo $r["_source"]['name'];?><?php if (!empty($r["_source"]['year'])) { echo ' ('.$r["_source"]['year'].')'; } ?></a>
                                        </p>
                                        <?php if (!empty($r["_source"]['alternateName'])) : ?>
                                        <p class="uk-margin-remove">Título original:
                                            <?php echo $r["_source"]['alternateName'];?></a></p>
                                        <?php endif; ?>
                                        <?php if (!empty($r["_source"]['nameOfpart'])) : ?>
                                        <p class="uk-margin-remove">Título específico:
                                            <?php echo implode(" ", $r["_source"]['nameOfpart']);?></a></p>
                                        <?php endif; ?>
                                        ...
                                        <p class="uk-text-small uk-margin-remove">In: <a
                                                href="result.php?search[]=isPartOf.name.keyword:&quot;<?php echo $r["_source"]['isPartOf']['name'];?>&quot;"><?php echo $r["_source"]['isPartOf']['name'];?></a>
                                        </p>
                                        <?php endif; ?>
                                        <p class="uk-text-small uk-margin-remove">
                                            ...
                                            <a
                                                href="result.php?search[]=about.keyword:&quot;<?php echo $assunto;?>&quot;"><?php echo $assunto;?></a>
                                            <?php endforeach;?>
                                            <?php endif; ?>
                                            ...
                                            <a
                                                href="result.php?search[]=genero_e_forma.keyword:&quot;<?php echo $genero_e_forma;?>&quot;"><?php echo $genero_e_forma;?></a>
                                            <?php endforeach;?>
                                            <?php endif; ?>
                                        </p>
                                        <p class="uk-text-small uk-margin-remove">
                                            ...
                                            <a
                                                href="result.php?search[]=USP.notes.keyword:&quot;<?php echo $notas;?>&quot;"><?php echo $notas;?></a>
                                            <?php endforeach;?>
                                            <?php endif; ?>
                                        </p>
                                        <p class="uk-text-small uk-margin-remove">
                                            ...
                                            <a
                                                href="result.php?search[]=USP.meio_de_expressao.keyword:&quot;<?php echo $meio_de_expressao;?>&quot;"><?php echo $meio_de_expressao;?></a>
                                            <?php endforeach;?>
                                            <?php endif; ?>
                                        </p>
                                        <?php if (!empty($r["_source"]['fatorimpacto'])) : ?>
                                        <p class="uk-text-small uk-margin-remove">Fator de impacto da publicação:
                                            <?php echo $r["_source"]['fatorimpacto'][0]; ?></p>
                                        <?php endif; ?>
                                        ...
                                        <div class="uk-alert-primary uk-margin-remove" uk-alert>
                                            ...
                                            <p>
                                                ...
                                                <?php if ($url != '') : ?>
                                                <a class="uk-button uk-button-primary uk-button-small uk-margin-remove"
                                                    href="<?php echo $url;?>" target="_blank">Primeira
                                                    página ou partitura completa</a>
                                                <?php endif; ?>
                                                <?php endforeach;?>
                                                <?php endif; ?>
                    ...
                    <div class="uk-child-width-expand@s uk-grid-divider" uk-grid>
                        <div>
                            <ul class="uk-pagination">
                                ...
                                <?php $get_data["page"] = $page-1 ; ?>
                                <li><a href="result.php?<?php echo http_build_query($get_data); ?>"><span
                                            class="uk-margin-small-right" uk-pagination-previous></span> Anterior</a>
                                </li>
                                <?php endif; ?>
                            </ul>
                        </div>
